namespace 阴阳易演.计算类
{
    ...
    {
        #region 内部参数
        static readonly Dictionary<节气枚举, List<八卦>> 八卦八节旺衰字典 = new Dictionary<节气枚举, List<八卦>>
        {
            { 节气枚举.立冬, new List<八卦> { 八卦.乾, 八卦.坎, 八卦.艮, 八卦.震, 八卦.巽, 八卦.离, 八卦.坤, 八卦.兑 } },
            { 节气枚举.立春, new List<八卦> { 八卦.艮, 八卦.震, 八卦.巽, 八卦.离, 八卦.坤, 八卦.兑, 八卦.乾, 八卦.坎 } },
            { 节气枚举.立夏, new List<八卦> { 八卦.巽, 八卦.离, 八卦.坤, 八卦.兑, 八卦.乾, 八卦.坎, 八卦.艮, 八卦.震 } },
            { 节气枚举.立秋, new List<八卦> { 八卦.坤, 八卦.兑, 八卦.乾, 八卦.坎, 八卦.艮, 八卦.震, 八卦.巽, 八卦.离 } },
            { 节气枚举.冬至, new List<八卦> { 八卦.坎, 八卦.艮, 八卦.震, 八卦.巽, 八卦.离, 八卦.坤, 八卦.兑, 八卦.乾 } },
            { 节气枚举.春分, new List<八卦> { 八卦.震, 八卦.巽, 八卦.离, 八卦.坤, 八卦.兑, 八卦.乾, 八卦.坎, 八卦.艮 } },
            { 节气枚举.夏至, new List<八卦> { 八卦.离, 八卦.坤, 八卦.兑, 八卦.乾, 八卦.坎, 八卦.艮, 八卦.震, 八卦.巽 } },
            { 节气枚举.秋分, new List<八卦> { 八卦.兑, 八卦.乾, 八卦.坎, 八卦.艮, 八卦.震, 八卦.巽, 八卦.离, 八卦.坤 } }
        };
        #endregion

        #region 扩展
        public static 八卦八节旺衰 八节旺衰(this 八卦 卦, 节气枚举 八节)
        {
        ...
        public static 节气枚举 八节旺衰(this 八卦 卦, 八卦八节旺衰 旺衰)
        {
